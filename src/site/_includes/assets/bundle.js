...
module_default$1.plugin(drawer);
module_default$1.plugin(navigation);
module_default$1.plugin(gtag);
module_default$1.plugin(comments);
module_default$1.plugin(image);
